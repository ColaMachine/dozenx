...
//        String tomcatPath = "/data/service/tomcat-spider-biz-8084";
        ...
        try {
            com.dozenx.common.util.ZipUtil.foldToZip(folderPath, localRootPathStr + "\\a.zip");
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//
    ...
    public static void update(String serverIp, String localZipFolder, String tomcatPath, String webappName, String userName, String pwd) {
        ...
        System.out.println("正在对folderPath进行打包" + folderPath);
        try {
            com.dozenx.common.util.ZipUtil.foldToZip(folderPath, localZipFolder + "\\a.zip");
        } catch (IOException e) {
            e.printStackTrace();
        }
        //把文件上传到服务器指定的目录
...
//
        ...
        String serverIps[] = new String[]{"192.168.212.89"};


        String localRootPathStr = "G:\\ssc-workspace\\SSCrobot\\code\\trunk\\risk\\target\\classes";
        String remoteRootPathStr = "/data/service/tomcat-awifi-risk-8090/awifi-risk/WEB-INF/classes";
        String tomcatPath = "/data/service/tomcat-awifi-risk-8090";
