...
public class VKMapping {
	...
	static{
		...
		map.put("num_5",KeyEvent.VK_NUMPAD5);
		map.put("num_0",KeyEvent.VK_NUMPAD0);
		map.put("num_.",KeyEvent.VK_DECIMAL);
	...
	public static void main(String args[]){
		try {
			System.out.println(User32.MapVirtualKeyA(map.get("0").intValue()));
			System.out.println(11|0x80);
		} catch (Exception e) {
