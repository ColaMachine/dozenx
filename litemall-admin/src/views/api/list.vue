<template>
  <div class="app-container">
    ...
    <el-dialog title="模块名称" :visible.sync="dialogFormVisible">
      <el-form :model="form">
      ...
      <el-col :span="18">
        ...
        <div class="grid-content bg-purple">
          ...
          <div class="filter-container">
            <el-input v-model="listQuery.interfaceNameLike" clearable class="filter-item" style="width: 200px;"
                      placeholder="请输入接口名称"/>
            <el-input v-model="listQuery.moduleNameLike" clearable class="filter-item" style="width: 200px;"
                      placeholder="所属模块"/>
            <el-input v-model="listQuery.urlLike" clearable class="filter-item" style="width: 200px;"
                      placeholder="url"/>
