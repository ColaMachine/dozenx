<template>
  <div class="app-container">
    ...
    <el-tabs v-model="activeName" >
        ...
        <el-card class="box-card">
          ...
          <el-table :data="apiParams">
            ...
            <el-table-column label="参数名称">
              <template slot-scope="scope">
                <el-input v-model="scope.row.paramName" type="textarea"/>
              </template>
            </el-table-column>
            ...
            <el-table-column label="参数值">
              <template slot-scope="scope">
                <template v-if="scope.row.paramType=='file'">
                  ...
                  <el-input v-model="scope.row.paramValue" type="file"/>
                </template>
                <template v-else >

                  <el-input v-model="scope.row.paramValue" type="textarea"/>
                </template>
            ...
            <el-table-column label="参数描述">
              <template slot-scope="scope">
                <el-input v-model="scope.row.paramComment" type="textarea"/>
              </template>
            </el-table-column>
      ...
      <el-tab-pane label="Body" name="fourth"><textarea
        id="interfaceBody"
        v-model="api.interfaceBody"
    ...
    <el-card class="box-card">
      ...
      <el-table :data="interfaceTests">
        ...
        <el-table-column label="参数值">
          <template slot-scope="scope">
            <el-input v-model="scope.row.params" type="textarea"/>
          </template>
        </el-table-column>
