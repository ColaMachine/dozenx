...
//        Template template = FreemarkerUtils.getTemplate(getTemplateName());
        ...
        try {
			InputStream fileInputStream = this.getClass().getResourceAsStream("/com/dozenx/swagger/support/internal/templates/ftlh/api.ftlh");
	...
	protected String buildResourcePath(HttpServletRequest request, Properties config) {
		...
		path = "com/dozenx/swagger/support/internal/statics"+path;
		return path;
	}
