...
public class HttpApiConnectionImpl implements HttpApi {
    ...
    public HttpResult get(String url, String params) {
        ...
        try{
            ...
            throw new InterfaceException(MessageUtil.getMessage("E2000018"), url, params, e);//接口异常!
        } finally {
    ...
    public HttpResult getStream(String url, String params) {
        ...
        try{
            ...
            throw new InterfaceException("E2000078", MessageUtil.getMessage("E2000078"), url, params, null, e);//接口超时!
        } catch (Exception e){
            throw new InterfaceException(MessageUtil.getMessage("E2000018"), url, params, e);//接口异常!
        }
