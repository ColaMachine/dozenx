...
package com.dozenx.web.core.log.sysLog.service.impl;
...
import com.dozenx.web.core.log.sysLog.dao.SysLogMapper;
...
public class SysLogServiceImpl extends BaseService implements SysLogService {
    ...
    public ResultDTO save(SysLog sysLog) {
      ...
      /* ValidateUtil<SysLog> vu = new ValidateUtil<SysLog>();
       ...
       //判断是更新还是插入
        if (sysLog.getId()==null ||  this.selectByPrimaryKey(sysLog.getId())==null) {
    ...
    */
    ...
    @Override
    public ResultDTO insertList(List<SysLog> list) {
       sysLogMapper.insertBatch(list);
        return null;
    }
}
