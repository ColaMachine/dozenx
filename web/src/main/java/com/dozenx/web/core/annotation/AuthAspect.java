...
public class AuthAspect {
    ...
    public Object validLogin(ProceedingJoinPoint pjp ) throws Throwable {
        ...
        //截取cookie 和header头部 如果发现没有cookie 就
...
//            BaseController baseController = (BaseController) BeanUtil.getBean("pubImageController") ;
            SessionUser session =  ((BaseController) BeanUtil.getBean("pubImageController")).getUser(request);
            if(session==null){
