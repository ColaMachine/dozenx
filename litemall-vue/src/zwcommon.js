...
var dialog={
   ...
   /* closeWindow:function(index){
    ...
    showMask:function(){
       ...
       function(){
                 // dialog.hideWidget(globalWidgetId);
                  dialog.hideWait();
                  dialog.hideMask();
               }
       );
    ...
    if(cancel.length>0){
            if (typeof(jso.cancelfn) != "undefined") {
                cancel[0].addEventListener("click",function(){
                    jso.cancelfn.call(this);removeDom(widget);
                    mask[0].style.display="none";
                });
            }else{
                 cancel[0].addEventListener("click",function(){
...
module.exports={Tool,StringUtil}