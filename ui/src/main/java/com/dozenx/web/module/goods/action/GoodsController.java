    ...
    */
    ...
    public ResultDTO update(HttpServletRequest request) throws Exception {//@PathVariable Long id,
        ...
        */
        ...
        vu.add("img", img, "图片",  new Rule[]{new Length(50),new NotEmpty()});
        vu.add("img1", img1, "图片",  new Rule[]{new Length(50)});
        vu.add("img2", img2, "图片",  new Rule[]{new Length(50)});
        vu.add("img3", img3, "图片",  new Rule[]{new Length(50)});
