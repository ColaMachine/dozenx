 ...
 */
package com.dozenx.net.netty;

import java.util.*;


public final class CoreRegistry {
    private static Map<Class<? extends Object>, Object> store = new HashMap<>();
    private static Set<Class<? extends Object>> permStore = new HashSet<>();
