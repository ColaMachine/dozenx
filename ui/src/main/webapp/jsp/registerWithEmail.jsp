    ...
    <div id="registerWrap" class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            ...
            <form id="registerForm" class="m-t" role="form" action="/sys/auth/registerPost.json">
                ...
                <button type="button" id="registerBtn" class="btn btn-primary block full-width m-b">注册</button>

                <p class="text-muted text-center"><small>已经有账号了吗?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="${path}/sys/auth/login.htm">登录</a>
            </form>
...
>>>>>>> cc31d99011a1aa0345526151942aa0ad2cbc90b0
