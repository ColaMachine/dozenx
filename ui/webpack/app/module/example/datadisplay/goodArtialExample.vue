...
import zwAppDialogue from '../../../component/datadisplay/zwAppDialogue.vue';
import zwTabs from '../../../component/datadisplay/zwTabs.vue';
export default {
    components:{zwRow,zwCol,zwIcon,zwBox,zwHeader,zwContent,zwFooter,zwLayout,zwSider,zwAppDialogue,zwTabs},
    data () {
