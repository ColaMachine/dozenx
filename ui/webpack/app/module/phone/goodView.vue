...
<p>  {{data.name}}</p>
 ...
 <div class="index-tit-banner" style="margin-top:0.3rem;background-color: #000;color:#fff;">
                         <ul>
                             <li class=""><s class="ui-icon zhengpin"></s><span>100%正品</span></li>
                             <li class=""><s class="ui-icon protect"></s><span>品牌授权</span></li>
                         </ul>
                     </div>
              <!-- <h3> 营业</h3>-->
          ...
          <zwCol class="pull-right" span=24>
              <zwPanel :canFold=false state="open" style="">
                  ...
                  <zwRow>
                            ...
                            <zwCol class="pull-right" span=24>
                              <p class="phone-artical" v-html="data.detail"> </p>
</zwCol>
                                    </zwRow>
