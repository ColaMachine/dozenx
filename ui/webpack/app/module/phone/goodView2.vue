 ...
 <zwPanel :canFold=false state="open" style="">
                                                   <span slot="title" name="title">评论</span>
                                                    <p  slot="body" name="body">
                                                         ...
                                                         <blogInput v-bind:pid="id" @submitCallBack="refreshBlogView"></blogInput>
                                                     </p>

                                                 </zwPanel>

<zwPanel style="display:none" :canFold=false state="open" >
<span slot="title" name="title">最新评论</span>
<p  slot="body" name="body">

<blogViewList v-bind:pid="id"  ref="blogViewList" ></blogViewList>
</p>
