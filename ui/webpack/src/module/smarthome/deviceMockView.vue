...
<div>
     <zwRow>
            ...
            <zwCol class="pull-right" span=24>
                ...
                <img class="zw-img-title-img"   :src="getImg('/static/img/smarthome/烟感'+(entity.deviceStatus.Online==1?'1':'2')+'.png')" ></img>
                ...
                <div style="width:70%;color:gray;padding-left:15px;">
                 <h1 style="font-size:15px;margin-top:-8px;">在线状态:{{entity.deviceStatus.Online==1?'正常':'离线'}}</h1>
                               ...
                               <span style="font-weight:bold;font-size:12px;">拆除状态:{{entity.deviceStatus.Removal==1?'报警':'正常'}}</span>
            </div>
