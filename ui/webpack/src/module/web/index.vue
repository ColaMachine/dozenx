          ...
          <zwRow style="">
            ...
            <zwCol style="min-width:300px" class="zw-col-sm-24 pull-left" span=17>
             ...
             <zwPanel :canFold=false state="open" style="">
                ...
                <p slot="body" name="body">
                  <zwPcImgBlocks :list="articleList"></zwPcImgBlocks>
            ...
            <zwCol style="min-width:300px" class="zw-col-sm-10 pull-left" span=6>
              <zwPanel :canFold=false state="open" style="">
                ...
                <p slot="body" name="body">
                  <zwSimpleTable :list="articleList" :param="tableParam"> </zwSimpleTable>
...
import zwPcImgBlocks from '../../component/datadisplay/zwPcImgBlocks.vue';
    ...
    data() {
      return {
        ...
        tableParam: [{
          ...
          width: 10,
          render:function(row){
            return  "<a href='/home/article/view.json?id="+row.id+"'>"+row.title+"</a>"
          }
        }, {
          name: 'subTitle',
          width: 10,
 ...
 Ajax.getJSON(PATH + "/article/list.json", {pageSize:10,curPage:1}, function(result) {
        if(result.r == AJAX_SUCC && result.data) {
