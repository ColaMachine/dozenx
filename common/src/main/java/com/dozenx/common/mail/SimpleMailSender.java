...
public class SimpleMailSender {
    ...
    public boolean sendTextMail(MailSenderInfo mailInfo) {
        ...
        try {
            ...
            if (StringUtil.isNotBlank(mailInfo.getUserName())) {
                from = new InternetAddress(mailInfo.getFromAddress(), javax.mail.internet.MimeUtility.encodeText(mailInfo.getUserName()));
            } else {
    ...
    public boolean sendSimpleTextMail(MailSenderInfo mailInfo) {
        // 判断是否需要身份认证
        MyAuthenticator authenticator = null;
        Properties pro = mailInfo.getProperties();
