...
package com.dozenx.web.core.auth.sysMenu.service.impl;
...
public class SysMenuServiceImpl extends BaseService implements SysMenuService {
    ...
    public ResultDTO save(SysMenu sysMenu) {
      ...
      /* ValidateUtil<SysMenu> vu = new ValidateUtil<SysMenu>();
       ...
       //判断是否有uq字段
        ...
        params.put("menuCode",sysMenu.getMenuCode());
    ...
    */
    ...
    @Override
    public ResultDTO insertList(List<SysMenu> list) {
       sysMenuMapper.insertBatch(list);
        return null;
    }
