...
package ${table.pkg}.${abc}.service.impl;
...
@Service("${abc}Service")
public class ${Abc}ServiceImpl extends BaseService implements ${Abc}Service {
    ...
    */
    ...
    public ResultDTO multilDelete(<@javaType>${table.pk.type}</@javaType>[] idAry) {
     ...
     /**
         ...
         * @return
         */
        public ResultDTO msave( ${parentType}[] ${table.mapper.parentid}AryReal, ${parentType}[] ${table.mapper.childid}AryReal) {
            //验证父亲id 正确性 是否存在
